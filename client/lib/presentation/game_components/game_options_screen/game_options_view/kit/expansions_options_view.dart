    ...
    final getAgendas = () => addPaddingsAndBackground(
          GameOptionView(
            ...
            onDropdownOptionChangedOrOptionToggled:
              ...
              final agenda = AgendaStyle.fromString(value?.$2);
              if (agenda != null &&
                  agenda !=
                      lobbyGame.createGameModel.politicalAgendasExtension) {
    ...
    final getStartingCEOs = () => addPaddingsAndBackground(
          GameOptionView(
            ...
            onDropdownOptionChangedOrOptionToggled:
              ...
              if (value != null &&
                  int.parse(value.$2) !=
                      lobbyGame.createGameModel.startingCeos) {
                final newCreateGameModel = lobbyGame.createGameModel
                    .copyWith(startingCeos: int.parse(value.$2));
