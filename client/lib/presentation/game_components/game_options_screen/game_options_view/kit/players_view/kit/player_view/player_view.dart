...
import 'package:mars_flutter/presentation/game_components/game_options_screen/game_options_view/kit/players_view/kit/player_view/kit/color_selection.dart';
              ...
              child: GameOptionContainer(
                ...
                child: GameOptionView(
                  ...
                  onDropdownOptionChangedOrOptionToggled:
                    ...
                    if (value != null && player.handicap != int.parse(value.$2))
                      onAnyOptionChanged(
                          player.copyWith(handicap: int.parse(value.$2)),
                          false);
                  }),
                ),
              ),
