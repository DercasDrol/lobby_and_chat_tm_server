...
import 'package:mars_flutter/presentation/game_components/lobby_screen/kit/game_options_view/filters_options_view/kit/checkboxes_filter_view.dart';
import 'package:mars_flutter/presentation/game_components/lobby_screen/kit/game_options_view/filters_options_view/kit/common/filter_popup.dart';
...
class FiltersOptionsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Function(String?)? prepareOnChangeFn(fn) => isChangesAllowed ? fn : null;
        ...
        GameOptionView(
          ...
          onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn((__) {
            ...
            showFilterPopup(
              ...
              onApply: () {
                final newCreateGameModel = lobbyGame.createGameModel.copyWith(
                  customPreludes: selectedPreludesN.value
        ...
        GameOptionView(
          ...
          onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn((__) {
            ...
            showFilterPopup(
              ...
              onApply: () {
                final newCreateGameModel = lobbyGame.createGameModel.copyWith(
                  customColonies: selectedColoniesN.value
