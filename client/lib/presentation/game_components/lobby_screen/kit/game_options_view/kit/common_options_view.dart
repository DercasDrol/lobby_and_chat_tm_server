            ...
            onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn(
              (value) {
                lobbyCubit.saveChangedOptions(
                  lobbyGame.copyWith(
                    createGameModel: lobbyGame.createGameModel.copyWith(
                      startingCorporations: int.parse(value),
                    ),
                  ),
                );
              },
              ...
              onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn(
                (value) {
                  lobbyCubit.saveChangedOptions(
                    lobbyGame.copyWith(
                      createGameModel: lobbyGame.createGameModel.copyWith(
                        escapeVelocityThreshold: int.parse(value),
                      ),
                    ),
                  );
                },
              ...
              onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn(
                (value) {
                  lobbyCubit.saveChangedOptions(
                    lobbyGame.copyWith(
                      createGameModel: lobbyGame.createGameModel.copyWith(
                        escapeVelocityBonusSeconds: int.parse(value),
                      ),
                    ),
                  );
                },
                  ...
                  onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn(
                    (value) {
                      lobbyCubit.saveChangedOptions(
                        lobbyGame.copyWith(
                          createGameModel: lobbyGame.createGameModel.copyWith(
                            escapeVelocityPenalty: int.parse(value),
                          ),
                        ),
                      );
                    },
                  ...
                  onDropdownOptionChangedOrOptionToggled: prepareOnChangeFn(
                    (value) {
                      lobbyCubit.saveChangedOptions(
                        lobbyGame.copyWith(
                          createGameModel: lobbyGame.createGameModel.copyWith(
                            escapeVelocityPeriod: int.parse(value),
                          ),
                        ),
                      );
                    },
